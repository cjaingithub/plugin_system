...
import { PluginAPI, createPluginAPI } from './modules/plugin-api';
...
import { FlowchartAPI, createFlowchartAPI } from './flowchart-api';
...
export const createElectronAPI = (): ElectronAPI => ({
  ...
  ...createProfileAPI(),
  ...createScreenshotAPI(),
  ...createFlowchartAPI(),  // Flowchart import operations
